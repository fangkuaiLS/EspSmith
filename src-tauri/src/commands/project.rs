...
fn detect_target_from_sdkconfig(project_dir: &PathBuf) -> Option<String> {
...
fn write_sdkconfig_defaults(project_dir: &PathBuf, target: &str, flash_size: Option<&str>) -> Result<(), String> {
