...
<p align="center">
  <img src="https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=A%20modern%2C%20sleek%20ESP32%20development%20studio%20logo%20featuring%20a%20stylized%20microchip%20with%20AI%20neural%20network%20patterns%2C%20dark%20theme%2C%20purple%20and%20blue%20accents%2C%20minimalist%20design%2C%20professional%20tech%20aesthetic&image_size=square_hd" alt="EspSmith Logo" width="200" />
</p>
...
| 类别                  | 功能                                                     |
| ------------------- | ------------------------------------------------------ |
| **AI 智能编程**         | 集成 DeepSeek-V3 / DeepSeek-R1 / Ollama 本地模型，自然语言驱动全闭环开发 |
...
| **Git 集成**          | 内置 Git 面板，支持 AI 提交、变更追踪、分支管理                           |
...
> 灵感来源：[AEL (AI Embedded Lab)](https://github.com/nicekwell/AI-Instrument-Closed-Loop) 的 `pipeline.py` / `runner.py`
...
> 灵感来源：[AEL (AI Embedded Lab)](https://github.com/nicekwell/AI-Instrument-Closed-Loop) 的 `civilization_client.py`
...
- **ESP-IDF Path**: ESP-IDF 安装目录（如 E:\espeim\.espressif\v5.5.4\esp-idf）
...
| 变量名               | 值                                                        | 说明                 |
| ----------------- | -------------------------------------------------------- | ------------------ |
| `OPENOCD_BIN`     | `C:\Espressif\tools\openocd-esp32\bin\openocd.exe`       | OpenOCD 可执行文件的完整路径 |
| `OPENOCD_SCRIPTS` | `C:\Espressif\tools\openocd-esp32\share\openocd\scripts` | OpenOCD 脚本目录路径     |

> **Windows 设置方法**：右键"此电脑" → 属性 → 高级系统设置 → 环境变量 → 系统变量 → 新建
