...
| 引擎 | 模型 | 特点 | 适用场景 |
| ---- | ---- | ---- | -------- |
| **CodeWhale** | deepseek-v4-pro / deepseek-v4-flash | DeepSeek 官方 API，响应快，支持思考过程展示 | 日常开发、快速迭代 |
| **MiMo-Code** | mimo/mimo-auto 等多模型 | 多模型支持，内置工具调用（文件读写、编译烧录），闭环能力强 | 复杂任务、需要深度调试 |
